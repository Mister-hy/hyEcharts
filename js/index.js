...
(function () {
  ...
  // 1. 实例化对象
  var myChart = echarts.init(document.querySelector(".Four"));
  // 2. 指定配置和数据
  var option = {
    grid: {
      top: "10%",
...
(function () {
  ...
  // 1. 实例化对象
  var myChart = echarts.init(document.querySelector(".Two"));
  // 2.指定配置
  var option = {
    // 通过这个color修改两条线的颜色
    color: ["#00f2f1", "#ed3f35"],
...
(function () {
  // 1.创建实例对象
  var myChart = echarts.init(document.querySelector(".Five"));
  // 2.指定配置和数据
  option = {
    tooltip: {
      trigger: "axis",
...
// 饼状图2 地区分布模块制作（南丁格尔玫瑰图）
(function () {
  // 1.创建实例对象
  var myChart = echarts.init(document.querySelector(".Six"));
  // 2.指定配置对象和数据
  option = {
    tooltip: {
      trigger: "item",
